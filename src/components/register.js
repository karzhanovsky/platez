    ...
    return (
      <div className="register">
        ...
        <form onSubmit={this.onFormSubmit}>
          ...
          <input type="text" value={this.state.username} onChange={this.onUsernameChange} placeholder="Nazwa użytkownika" />
          {this.state.username.length > 0 && <p>Nazwa {this.state.username} jest {this.state.usernameAvailable ? <span className="usernameAvailable">wolna</span> : <span className="usernameUnavailable">zajęta</span>}</p>}
